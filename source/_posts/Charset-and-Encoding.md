...
避免立下太多flag，决定不再单独开博客介绍Java中涉及的编码方式了，记住“传输存储用UTF8，内存操作用UTF16”这句话基本可以应对大多数场景需求了，感兴趣的童鞋可以移步下面这几篇专门讨论Java编码原理的博客：

[文本在内存中的编码()](https://my.oschina.net/goldenshaw/blog/470946)
